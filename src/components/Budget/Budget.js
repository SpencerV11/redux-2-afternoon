...
import { requestBudgetData, addPurchase, deleteItem } from './../../ducks/budgetReducer'
        ...
        <div className='budget-container'>
          ...
          <div className='content-container'>
            <div className="purchases-container">
              ...
              <DisplayPurchases purchases={this.props.budget.purchases} removePurchase={this.props.deleteItem} />
            </div>
...
export default connect(mapStateToProps, {requestUserData, requestBudgetData, addPurchase, deleteItem})(Budget);
